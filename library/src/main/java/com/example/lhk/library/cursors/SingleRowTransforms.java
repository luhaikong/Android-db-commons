package com.example.lhk.library.cursors;
 ...
 * {@link Cursor} row to {@link String} or boxed
 * primitive type.
 *
 * The constructed Functions are not thread-safe, but can be reused with
 * multiple Cursors.
 *
 * All constructed Functions return null when the {@link Cursor#isNull(int)}
...
public final class SingleRowTransforms {
  ...
  public static class Builder {
     ...
     * specified column in {@link Cursor} row to
     * {@link String}
     */
